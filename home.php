...
<div class="col-lg-9 mt-2">
        ...
        <div class="carousel-inner rounded">
            ...
            ?>
                <div class="carousel-item <?php echo $aktif ?>">
                    <img src="assets/img/<?php echo $data['gambar'] ?>" class="img-fluid" style="height: 300px; width: 1000px; object-fit:cover" alt="...">
    ...
    <div class="card mt-4 border-0 bg-light">
        <div class="card-body text-center">
            <h5 class="card-title fs-5">==CoffeNers==</h5>
            <p class="card-text fs-5">Improve your feeling by taste it</p>
            <a href="pesan" class="btn btn-primary fs-5">Pesan Sekarang</a>
        </div>
    </div>
